...
/// <summary>
/// Скрипт-генератор. Используется для создания префаб-объекта Сетка клеток.
/// Пустой объект с этим скриптом создаёт в себе двумерный массив объектов Клетка.
/// Дополнительная настройка: Передать скрипту префаб-объект Клетка, установить габариты сетки.
/// </summary>
